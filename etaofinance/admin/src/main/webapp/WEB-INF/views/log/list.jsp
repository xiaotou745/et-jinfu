			...
			<div class="row">
				<div class="col-lg-3">
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" placeholder="日志内容" class="form-control" id="Description" />
						</div>
					</div>
				</div>
				<div class="col-lg-3">
					<div class="form-group">
						<label class="col-sm-5 control-label">日志时间:</label>
						<div class="col-sm-7">
				...
				<div class="col-lg-2">
					<button type="button" class="btn btn-w-m btn-primary" id="btnSearch" style="margin-left: 70px;">查询</button>
				</div>
			</div>
		</div>
	</div>
