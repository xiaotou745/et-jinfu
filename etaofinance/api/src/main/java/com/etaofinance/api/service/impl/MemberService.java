...
public class MemberService implements IMemberService {
	 ...
	 */
	@Override
	public HttpResultModel<ModifyPhoneResp> modifyPhoneByMessageOne(
			ModifyPhoneByMessageReq req) {
		HttpResultModel<ModifyPhoneResp> resultModel=new HttpResultModel<ModifyPhoneResp>();				
		//手机验证码
	 ...
	 */
	@Override
	public HttpResultModel<ModifyPhoneResp> modifyPhoneTwo(
			ModifyPhoneByMessageReq req) {
		HttpResultModel<ModifyPhoneResp> resultModel=new HttpResultModel<ModifyPhoneResp>();	
